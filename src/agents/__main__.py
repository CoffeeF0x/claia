#!/usr/bin/env python3
"""
Demo selector for the agents module classes.
Allows user to select and test different agent functionality.
"""
...
def display_menu() -> None:
  ...
  print("\n" + "="*50)
  print("     CLAIA Agents Module Demo Selector")
  print("="*50)
...
def handle_demo_selection(selected_demo: str, session_dir: str) -> None:
  ...
  demo_map = {
    "Mock Agent 1 Demo": MockAgent1Demo(session_dir).run,
    "Mock Agent 2 Demo": MockAgent2Demo(session_dir).run
  }
...
def main() -> None:
  ...
  print("Welcome to the CLAIA Agents Module Demo!")
  print("This demonstrates mock functionality for the agents module classes.")
