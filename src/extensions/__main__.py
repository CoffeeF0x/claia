#!/usr/bin/env python3
"""
Demo selector for the extensions module classes.
Allows user to select and test different extension functionality.
"""
...
def display_menu() -> None:
  ...
  print("\n" + "="*50)
  print("     CLAIA Extensions Module Demo Selector")
  print("="*50)
...
def handle_demo_selection(selected_demo: str, session_dir: str) -> None:
  ...
  demo_map = {
    "Mock Extension 1 Demo": MockExtension1Demo(session_dir).run,
    "Mock Extension 2 Demo": MockExtension2Demo(session_dir).run
  }
...
def main() -> None:
  ...
  print("Welcome to the CLAIA Extensions Module Demo!")
  print("This demonstrates mock functionality for the extensions module classes.")
