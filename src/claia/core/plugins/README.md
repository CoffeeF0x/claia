...
Core plugins return these dataclasses from their contract methods. `claia.framework.Manager` reads the metadata, filters kwargs against `ParamSpec`, masks secrets in logs, and exposes settings to the CLI.
